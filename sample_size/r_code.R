...
pmsampsize(type = "b", prevalence = 0.10, cstatistic = 0.91, parameters = 16)
...
pmsampsize(type = "b", prevalence = 0.10, cstatistic = 0.99, parameters = 16)
...
# pmsampsize(type = "b", prevalence = 0.25, cstatistic = 1.00, parameters = 19)
...
pmsampsize(type = "b", prevalence = 0.10, cstatistic = 0.9622, parameters = 16)
